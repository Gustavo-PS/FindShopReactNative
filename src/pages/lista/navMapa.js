...
export default function NavMapa({route, navigation}) {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.btnBack} onPress={() => navigation.navigate('Lista')}>
      ...
      <SafeAreaView style={[styles.container, animatedStyle]}>
        <GestureDetector gesture={pinchZoom}>
          <Animated.Image style={styles.mapa} source={imagem} />
        </GestureDetector>
      </SafeAreaView>
    </View>
